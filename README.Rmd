...
```{r robust est resboxhide, echo = FALSE, results = "hide"}
##########################################
...
plot( predichos_ROB_LINEAL, residuos_ROB_LINEAL_tecdatos, xlab=expression(hat(y[i])), ylab=expression(r[i]), cex=1.3, cex.lab=1.3, main="FLM")
 abline(h=boxplot(residuos_ROB_LINEAL_tecdatos)$stats[1,1],col="red")
abline(h=boxplot(residuos_ROB_LINEAL_tecdatos)$stats[5,1],col="red")
...
abline(h=boxplot(residuos_ROB_CUADRA_tecdatos)$stats[1,1],col="red")
abline(h=boxplot(residuos_ROB_CUADRA_tecdatos)$stats[5,1],col="red")
par(mfrow=c(1,1))
```
