...
```{r X(t), echo=FALSE, fig.height=6, fig.width=8}
...
```{r robust est resboxhide, results='hide', cache=FALSE, results=FALSE, warning=FALSE, comment=FALSE, message=FALSE, echo=FALSE}
##########################################
...
```{r robust est atypical curves, echo=FALSE, fig.height=6, fig.width=8}
######################################
...
```{r robust est beta FLM, echo=FALSE, fig.height=6, fig.width=8}
##############################################
...
```{r robust est beta gamma FQM, echo=FALSE, fig.height=6, fig.width=8}
##############################################
...
```{r robust est6, echo=FALSE, fig.height=6, fig.width=8}
##############################################
