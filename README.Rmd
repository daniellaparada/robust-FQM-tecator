...
```{r X(t), echo=FALSE, fig.height=6, fig.width=6}
...
```{r robust est resboxhide, echo = FALSE, eval = TRUE, results = "hide"}
##########################################
...
```{r robust est atypical curves, echo=FALSE, fig.height=6, fig.width=6}
######################################
...
```{r robust est beta FLM, echo=FALSE, fig.height=6, fig.width=6}
##############################################
...
```{r robust est beta gamma FQM, echo=FALSE, fig.height=6, fig.width=6}
##############################################
