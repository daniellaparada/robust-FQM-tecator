...
Estimates comparison $\beta$ from FLM and FQM.
...
points(tecdatos$t, beta_rob_LINEAL, type = "l", lwd=3, pch = 10,
     col = "steelblue")
legend(1000, -200, legend=c("LIN", "QUAD"),
       col=c("steelblue", "tomato"), lty=1, lwd=3, cex=1, bty="n")
```
...
In both cases, FLM and FQM, we choose 4 principal directions which explain more than 97% of the total variability as seen below.
...
We now repeat the classical analysis, both for FLM and FQM, without the outliers that have been identified in the residual boxplot from the robust FQM fit. We choose 4 principal directions whiich explain more than 97% of the variability.
