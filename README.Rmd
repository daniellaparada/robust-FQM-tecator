...
```{r robust est resboxhide, echo = FALSE, results = FALSE}
##########################################
...
par(mar=c(5.1, 22.1, 4.1, 22.1))
plot(tecdatos$t, beta_rob_CUADRA  , type = "l", lwd=3, xlab = "Wavelength", pch = 10,
     col = "tomato", ylab = expression(hat(beta)))
points(tecdatos$t, beta_rob_LINEAL, type = "l", lwd=3, pch = 10,
     col = "steelblue")
legend(100, -200, legend=c("FLM", "FQM"),
       col=c("steelblue", "tomato"), lty=1, lwd=3, cex=0.8)
```
